...
!(function (e, n) {
  ...
  function f(e, n, t) {
    g.push({ command: e, callback: n, originalPhrase: t }),
    ...
    for (var t = 0; t < e.length; t++) {
      ...
      for (var o = 0, r = g.length; o < r; o++) {
        ...
        if (a) {
          ...
          return (
            b &&
              (u('command matched: %c' + i.originalPhrase, v),
              c.length && u('with parameters', c)),
            i.callback.apply(this, c),
            void s(m.resultMatch, n, i.originalPhrase, e)
          )
        }
      }
    }
  ...
  return (o = {
    ...
    start: function (e) {
      c(),
        (w = (e = e || {}).paused !== i && !!e.paused),
        (p = e.autoRestart === i || !!e.autoRestart),
        e.continuous !== i && (d.continuous = !!e.continuous),
        (h = new Date().getTime())
      try {
        d.start()
      } catch (e) {
    ...
    addCallback: function (e, n, t) {
      ...
      'function' == typeof o &&
        m[e] !== i &&
        m[e].push({ callback: o, context: t || this })
    },
    ...
    init: function (e, n) {
      ...
      d && d.abort && d.abort(),
        ((d = new a()).maxAlternatives = 5),
        (d.continuous = 'http:' === r.location.protocol),
        (d.lang = 'en-US'),
        (d.onstart = function () {
          ;(S = !0), s(m.start)
        }),
        ...
        (d.onerror = function (e) {
          switch ((s(m.error, e), e.error)) {
            ...
            case 'service-not-allowed':
              ;(p = !1),
                new Date().getTime() - h < 200
                  ? s(m.errorPermissionBlocked, e)
                  : s(m.errorPermissionDenied, e)
          }
        }),
        (d.onend = function () {
          if (((S = !1), s(m.end), p)) {
